...
class AmpacityTableRegistry {
  ...
  static const tables = <AmpacityTableMetadata>[
    ...
    AmpacityTableMetadata(
      table: AmpacityTable.table523,
      tableId: '5-23',
      displayName: 'Table 5-23',
      category: 'Copper PVC sheathed cable ampacity - underground',
      conductorMaterial: 'Copper',
      insulationTypes: [CableInsulation.pvc],
      conductorTemperatureClasses: [ConductorTemperatureClass.pvc70],
      referenceAmbientTemperatureC: 30,
      installationGroups: [],
      installationGroupNumbers: [5, 6],
      applicableCableTypes: [
        CableType.nyy,
        CableType.nyyG,
        CableType.vct,
      ...
      schemaType: AmpacityTableSchema.underground,
      correctionTableReferences: [
        'Table 5-8',
        'Table 5-44',
        'Table 5-45',
        'Table 5-46',
    ...
    AmpacityTableMetadata(
      table: AmpacityTable.table529,
      tableId: '5-29',
      displayName: 'Table 5-29',
      category: 'Copper XLPE sheathed cable ampacity - underground',
      conductorMaterial: 'Copper',
      insulationTypes: [CableInsulation.xlpe],
      conductorTemperatureClasses: [ConductorTemperatureClass.xlpeEpr90],
      referenceAmbientTemperatureC: 30,
